...
To calculate N in populate graph, N = num_users * avg_friendships // 2
-then looping thru the range of N
-add_friendship() will be called N times
-in this case it'll be called 500 times
...
40% based upon avg len of each path to get to a friend by total number of users

What is the average degree of separation between a user and those in his/her extended network?
AVG separation is 4th degree
